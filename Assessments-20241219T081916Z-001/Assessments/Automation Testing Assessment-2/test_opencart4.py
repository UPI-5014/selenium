...
# Step 1: Open the URL and Login with details
...
# Enter login details
driver.find_element(By.ID, "input-email").send_keys("208r1a05i2cse@gmail.com")
driver.find_element(By.ID, "input-password").send_keys("Lasmaiah@5014")
